class Fields {
  ...
  static const String account_total_balance = "account_total_balance";

  static const List<String> values = [account_id, wallet_id, account_name, account_balance, account_total_balance];
}
...
class Accounts {
  ...
  final double account_total_balance;
  ...
  Accounts({
    ...
    required this.account_total_balance
  });
  ...
  Map<String, dynamic> toMap(){
    return {
      ...
      Fields.account_total_balance: account_total_balance
    };
  }
  ...
  factory Accounts.fromMap(Map<String, dynamic> map) {
    return Accounts(
      ...
      account_total_balance: map["account_total_balance"] as double
    );
  }
}
